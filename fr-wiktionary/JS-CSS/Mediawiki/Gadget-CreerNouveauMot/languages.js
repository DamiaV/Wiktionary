  ...
  load: function (gadget) {
    ...
    gadget.addLanguage(new Language(
        ...
        [
          ...
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.PROPER_NOUN, [], getFrenchModel),
          ...
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.LAST_NAME, [], getFrenchModel),
          ...
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.FIRST_NAME, [], getFrenchModel),
    ...
    gadget.addLanguage(new Language(
        ...
        [
          ...
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.PROPER_NOUN, [], getEnglishModel),
    ...
    gadget.addLanguage(new Language(
        ...
        [
          ...
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.PROPER_NOUN, [], getItalianModel),
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.VERB, [[this.VERBS.GROUP1, this.VERBS.GROUP2, this.VERBS.GROUP3]]),
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.PHRASE),
          ...
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.LAST_NAME, [], getItalianModel),
          ...
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.PREFIX),
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.FIRST_NAME, [], getItalianModel),
    ...
    gadget.addLanguage(new Language(
        ...
        [
          ...
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.PROPER_NOUN, [], getPortugueseModel),
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.VERB, [[this.VERBS.GROUP1, this.VERBS.GROUP2, this.VERBS.GROUP3]]),
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.PHRASE),
          ...
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.LAST_NAME, [], getPortugueseModel),
          ...
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.PREFIX),
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.FIRST_NAME, [], getPortugueseModel),
    ...
    gadget.addLanguage(new Language(
        ...
        [
          ...
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.PROPER_NOUN, [], getBretonModel),
          ...
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.LAST_NAME, [], getBretonModel),
          ...
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.PREFIX),
          new GrammaticalItem(this.GRAMMATICAL_CLASSES.FIRST_NAME, [], getBretonModel),
