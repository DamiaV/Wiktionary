...
/**
 * @typedef {JQuery<HTMLInputElement|HTMLTextAreaElement>} JQueryTextInput
 */

/**
 * Returns the edit box as a jQuery object.
 * @return {JQuery<HTMLTextAreaElement> & {wikiEditor?: function}|null} The jQuery element corresponding
 ...
 * @param $textInput {JQueryTextInput?} The text input or textarea to use instead of the main edit box.
 * @return {string|null}
 */
...
function getSelectedText($textInput) {
  ...
  return String($editBox.val()).substring(start, end);
}
 ...
 * @return {any|null} The toolbar or null if it is disabled.
 */
function getToolbar() {
 ...
 * @return {CodeMirror.Editor} CodeMirror handle.
 */
 ...
 * @return {JQuery<HTMLInputElement>} The edit summary field.
 */
